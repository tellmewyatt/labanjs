...
staff1.addStretchedSymbol({ xSpaces: 2, widthSpaces: 1, startTime: 1+5, endTime: 2+5, symbol: right, level: 'middle' })
staff1.addStretchedSymbol({ xSpaces: 2, widthSpaces: 1, startTime: 2+5, endTime: 5+5, symbol: forward })
